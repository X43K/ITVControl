...
2. Sube los archivos a un servidor con PHP 7.4+.
   No requiere base de datos
3. Asegúrate de que tu servidor tenga PHP instalado.
4. Coloca todos los archivos en una carpeta, por ejemplo `/var/www/html/itv/`.
5. Accede a `'ip-host'/itv/index.php` en tu navegador.
6. Inicia sesión con las credenciales predeterminadas:
   - Usuario: `admin`
   - Contraseña: `admin`
7. A partir de ahí podrás gestionar los vehículos, las citas, las estaciones, imprimir las caducidades y las citas de cada mes, así como los usuarios y su rol.

## Válido para instalar como aplicacion web

## Credenciales por defecto
- usuario: `admin` contraseña: `admin` (con control total)
- usuario: `usuario` contraseña: `usuario` (solo puede consultar e imprimir)
